...
echo "Starting svm_baseline run"
echo "NAME: $NAME"
...
python $LOCAL_BASE_DIR/architectures/svm_baseline/main.py --train --train-path $DATA_BASE_PATH-train --embedding-path $EMBEDDING_PATH --model-store-path $MODEL_STORE_PATH --svm-kernel linear
