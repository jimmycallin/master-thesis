...
cp -r architectures/conll16st-v34-focused-rnns $SCRATCH
...
./v34/train.py $MODEL_STORE_PATH $DATA_BASE_PATH-train $DATA_BASE_PATH-dev --clean "$CONFIG" --static_input_embedding
