...
for embedding in word_embeddings:
	...
	print("Training " + name)
	call(["sbatch", "--job-name", name, "--output=/usit/abel/u1/jimmycallin/models/" + name + "/stdout.txt", "/usit/abel/u1/jimmycallin/architectures/abel_train_rnn.sh", name, embedding["path"]])
