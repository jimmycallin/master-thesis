...
echo '==============TRAIN======================='
echo '=========================================='
python $LOCAL_BASE_DIR/architectures/svm_baseline/main.py -c 1024 --test --test-path $INPUT_PATH --embedding-path $EMBEDDING_PATH --model-store-path $MODEL_PATH --test-output-path $OUTPUT_PATH
