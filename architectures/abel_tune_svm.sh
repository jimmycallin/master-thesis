...
python $LOCAL_BASE_DIR/architectures/svm_baseline/main.py -c $3 --train --train-path $DATA_BASE_PATH-train --embedding-path $EMBEDDING_PATH --model-store-path $MODEL_STORE_PATH
