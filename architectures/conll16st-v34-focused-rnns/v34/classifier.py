...
for var in ['args.lang', 'args.model_dir', 'args.dataset_dir', 'args.output_dir', 'K._config', 'os.getenv("THEANO_FLAGS")', 'filter_types', 'filter_senses', 'filter_fn_name', 'config']:
